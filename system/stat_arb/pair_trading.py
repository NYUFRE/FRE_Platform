...
def cointegration_test(ticker1, ticker2):
    ...
    #should there be more precise checks on dates?
...
def build_pair_trading_model():
    """
    This function build a pair_trading model for technology stocks in sp500 and update database tables
    """

    #should we add a param sector in the function?
    sector = "Technology"
