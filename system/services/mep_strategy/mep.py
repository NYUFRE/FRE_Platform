from system.services.mep_strategy.mep_common import search_optimal_parameters
from system.services.mep_strategy.mep_strategy_executor import MEPStrategyExecutor
...
stock_collection = {
    ...
    'communication controllers': { 'FB', 'GOOGL', 'GOOG' },
    'real estate': { 'AMT', 'SPG' }
}
...
industry_description = {
    ...
    'communication controllers': "Social media giant Facebook (NASDAQ:FB) and search engine pioneer Alphabet (NASDAQ:GOOGL) (NASDAQ:GOOG) are among the biggest stocks in communication controllers.",
