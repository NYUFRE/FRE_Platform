...
from system.ai_modeling.ga_portfolio_new import Stock, Trade, Fundamental, GAPortfolio, PORTFOLIO_NUM_OF_STOCK
...
end_date = dt.date(2021,1,1).strftime('%Y-%m-%d')

def create_populate_tables(database, eod_market_data) -> None:
