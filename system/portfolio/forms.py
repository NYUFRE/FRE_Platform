...
class RegisterForm(FlaskForm):
    ...
    #last_name = StringField('Last Name', validators=[DataRequired(), Length(min=6, max=40)])
    #first_name = StringField('First Name', validators=[DataRequired(), Length(min=6, max=40)])
